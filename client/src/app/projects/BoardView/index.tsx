...
const taskStatus = ["To Do", "In Progress", "Stage", "QC", "Done"];
  ...
  return (
    ...
    >
      <div className="mb-3 flex w-full">
        ...
        />
        <div className="rounded-e-large dark:bg-dark-secondary flex w-full items-center justify-between bg-white px-5 py-4">
  ...
  return (
    ...
    >
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="my-3 flex justify-baseline">
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://untask-s3.s3.eu-central-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://untask-s3.s3.eu-central-1.amazonaws.com/${task.author.profilePictureUrl!}`}
